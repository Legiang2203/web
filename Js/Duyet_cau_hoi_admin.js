    ...
    if(takelocol.length === 0){
        ...
        takelocol.forEach((key, i) => {
            ...
            <td>
                ...
                <button type="button" id="duyet" class="xoa_${i}" onclick="duyet(${i})">Duyệt</button>
                <button type="button" id="khongduyet" class="xoa_${i}" onclick="khongduyet(${i})">Không duyệt</button>
